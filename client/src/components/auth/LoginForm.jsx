...
const LoginForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] relative overflow-hidden px-4">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-400/10 rounded-full blur-3xl animate-float" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-indigo-400/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '-3s' }} />
      ...
      <div className="max-w-md w-full glass-card rounded-2xl p-8 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <Button
            ...
            loading={loading}
            className="btn-primary w-full py-3 shadow-blue-500/30"
          >
            Sign In
          </Button>
